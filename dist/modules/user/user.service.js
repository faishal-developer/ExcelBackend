...
const updateUser = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isExist.role === 'admin' && (data.role === user_model_1.role[1] || data.role === user_model_1.role[2])) {
        throw new ApiError_1.default(http_status_1.default.METHOD_NOT_ALLOWED, "Admin should not be modified");
    }
    if ((isExist.role === user_model_1.role[1] || isExist.role === user_model_1.role[2]) && data.role === 'admin') {
...
const updateMyProfile = (accessToken, data) => __awaiter(void 0, void 0, void 0, function* () {
    const verifiedUser = (0, commonFunction_1.verifyAccessToken)(accessToken);
    const isExist = yield user_model_1.User.findOne({ phoneNumber: verifiedUser.phoneNumber });
    if (!isExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, "User not found !");
    }
