...
router.get("/cows/:id", (0, Authorization_1.auth)([utils_1.userRoles.admin, utils_1.userRoles.buyer, utils_1.userRoles.admin]), cow_controller_1.cowsController.getSingleCow);
